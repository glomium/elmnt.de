    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('formular', models.CharField(default=b'cmsplugin_mailform.examples.ContactForm', max_length=200, verbose_name='Form', choices=[(b'cmsplugin_mailform.examples.ContactForm', 'Contactform')])),
